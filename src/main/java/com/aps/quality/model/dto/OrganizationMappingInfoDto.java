...
public class OrganizationMappingInfoDto implements Serializable {
    @ApiModelProperty(name = "organizationMappingId", required = false, example = "", notes = "ID")
    ...
    @ApiModelProperty(name = "childOrganizationId", required = false, example = "", notes = "子组织ID")
