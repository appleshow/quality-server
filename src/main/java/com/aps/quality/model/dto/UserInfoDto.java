...
public class UserInfoDto implements Serializable {
    ...
    @ApiModelProperty(name = "userRoleInfos", required = true, example = "test", notes = "用户权限")
    private List<UserRoleInfoDto> userRoleInfos;
    @ApiModelProperty(name = "userOrganizationInfos", required = true, example = "test", notes = "用户组织")
    private List<UserOrganizationInfo> userOrganizationInfos;
}
