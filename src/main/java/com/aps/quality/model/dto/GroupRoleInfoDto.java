...
public class GroupRoleInfoDto implements Serializable {
    @ApiModelProperty(name = "groupRoleId", required = false, example = "", notes = "ID")
    ...
    @ApiModelProperty(name = "roleInfo", required = true, example = "", notes = "权限信息")
